    ...
    <div name="skills" className="w-full h-screen bg-[#0a192f] text-gray-300">
      ...
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-5 text-center py-8">
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-20 mx-auto" src={TS} alt="CSS icon" />
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-20 mx-auto" src={Mongo} alt="MONGO DB" />
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-20 mx-auto" src={K8s} alt="KUBERNETES icon" />
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-20 mx-auto" src={Terraform} alt="GITHUB icon" />
            <p className="my-4">TERRFORM</p>
          </div>
